...
function SignUp() {
    ...
    const handleSubmit = async (e) =>{
        ...
        try{
            setLoading(true);
            const res = await axios.post('https://luka-social-media-application-1.onrender.com/api/v1/user/register',userInfo, {headers:{"Content-Type":'application/json'}, withCredentials:true });
            if(res.data.success){
