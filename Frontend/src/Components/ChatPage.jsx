...
function ChatPage() {
    ...
    const sendMessageHandler = async() => {
        try{
            const res = await axios.post(`https://luka-social-media-application.onrender.com/api/v1/messages/send/${SelectedUser?._id}`,{textMessage},{headers:{"Content-Type":'application/json'},withCredentials:true});
            if(res.data.success){
