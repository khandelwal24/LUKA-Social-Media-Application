...
const EditProfile = () => {
    ...
    const HandleSubmit = async (e) =>{
        ...
        try{
            setloader(true);
            const res = await axios.post('https://luka-social-media-application-1.onrender.com/api/v1/user/profile/edits',formdata,{headers:{"Content-Type":'multipart/form-data'},withCredentials:true});
            if(res.data.success){
