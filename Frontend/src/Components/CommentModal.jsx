...
function CommentModal({closeModal,post}) {
    ...
    const commentHandler = async () =>{
        try{
         const res = await axios.post(`https://luka-social-media-application-1.onrender.com/api/v1/posts/${selectedPost._id}/comment`,{text},{headers:{"Content-Type":'application/json'},withCredentials:true});
         if(res.data.success){
