...
function CreatePostModal({openPostModal,setOpenPostModal,closemodal}) {
    ...
    const createPostHandler = async(e)=>{
      ...
      // console.log('Pic wala :', pic, "Caption :",caption);
        ...
        try{
          setLoader(true);
          const res = await axios.post('https://luka-social-media-application-1.onrender.com/api/v1/posts/addPost', formData, {headers:{"Content-Type":'multipart/form-data'}, withCredentials:true})
          if(res.data.success){
